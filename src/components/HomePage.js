  ...
  return (
    <div>
      ...
      <section id="despre">
        <h2>Despre Noi</h2>
        <p>
          Suntem o cofetărie artizanală dedicată creării celor mai delicioase prăjituri, torturi și delicii dulci.
          Folosim doar ingrediente naturale și rețete tradiționale pentru a-ți aduce gustul autentic al deserturilor.
        </p>
      </section>
